...
public class OrquestadorService {
	...
	public String fullAnswer() {
		...
		String resourseUrl1 = ("http://localhost:8090/v1/getOneEnigma/getNewStep");
		String resourseUrl2 = ("http://localhost:8091/v1/getOneEnigma/getNewStep");
		String resourseUrl3 = ("http://localhost:8092/v1/getOneEnigma/getNewStep");
