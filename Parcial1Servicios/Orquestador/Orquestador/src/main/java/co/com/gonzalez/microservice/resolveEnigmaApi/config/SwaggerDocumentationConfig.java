package co.com.gonzalez.microservice.resolveEnigmaApi.config;
...
public class SwaggerDocumentationConfig {
    ...
    public Docket customImplementation(){
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                .apis(RequestHandlerSelectors.basePackage("co.com.gonzalez.microservice.resolveEnigmaApi.api"))
