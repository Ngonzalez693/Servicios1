package co.com.gonzalez.microservice.resolveEnigmaApi.routes;
...
import co.com.gonzalez.microservice.resolveEnigmaApi.strategy.JoinReplyAggregationStrategy;
		  ...
		  JoinReplyAggregationStrategy myAggregationStrategy = new JoinReplyAggregationStrategy();
	        ...
	        .process(new Processor() {
	            ...
	            public void process(Exchange exchange) throws Exception {
	                ...
	                exchange.setProperty("ServiceEnigma", serviceRequestBody.getData().get(0).getStep());
